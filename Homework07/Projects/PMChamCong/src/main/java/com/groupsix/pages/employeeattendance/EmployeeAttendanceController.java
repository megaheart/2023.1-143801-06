...
public class EmployeeAttendanceController {
	...
	public OfficerAttendanceReport getEmployeeReport(Employee employee, int month, int year, int monthCount) {
		return null;
	}

	public void openView(Employee employee, int month, int year) {
